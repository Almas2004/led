...
import { ChevronLeft, ShieldCheck, Zap, Smartphone, Package, Image as ImageIcon } from 'lucide-react';
            ...
            <div>
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-3xl p-8 mb-8">
                ...
                <p className="text-4xl font-black text-blue-700">
                  {product.priceFrom?.toLocaleString() || '---'} ₸ <span className="text-lg font-bold text-blue-400">/ м²</span>
                </p>
