          ...
          <div>
            ...
            <div className="mt-8 p-6 bg-blue-50 rounded-2xl border border-blue-100">
              <h5 className="font-bold text-blue-900 mb-2">
                Ваш надежный партнер по LED-решениям
              </h5>
              <ul className="text-sm text-blue-800 space-y-2">
                <li>
                  • Официальная работа с НДС — юридическая прозрачность и уверенность
                </li>
                <li>
                  • Локальный склад и сервис в РК — быстрый запуск и поддержка без ожидания
                </li>
                <li>
                  • Обучение и сопровождение — ваша команда полностью готова к работе с первого дня
                </li>
              </ul>
            </div>
          </div>
